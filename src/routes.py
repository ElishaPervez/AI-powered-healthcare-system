...
data_path = os.path.join(current_dir, "data", "datasets")
ml_model_path = os.path.join(current_dir, "data", "ml_models")

sym_des = pd.read_csv(os.path.join(data_path, "symtoms_df.csv"))
...
svc = pickle.load(open(os.path.join(ml_model_path, 'svc.pkl'),'rb'))
